package com.hao.gulimall.member.interceptor;
...
public class LoginUserInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        boolean match = antPathMatcher.match("/member/memberreceiveaddress/**", uri); // 当前请求与前者对比
        boolean match1 = antPathMatcher.match("/member/member/**", uri);
        if (match || match1){
            return true;
        }
