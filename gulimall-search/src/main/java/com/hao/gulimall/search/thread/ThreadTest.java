package com.hao.gulimall.search.thread;
import java.util.concurrent.*;


/**
 * @author zhouhao
 * @PackageName:com.hao.gulimall.search.thread
 * @Description:
...
public class ThreadTest {
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        //System.out.println(futureTask.get());// get方法阻塞等待异步执行结束获取结果
        ...
        // 4.创建常用的4种线程池，底层都是使用原生线程池创建，参数设置不同
        ...
        // 5.2.获取上一步结果并链式异步调用(thenApplyAsync)【能获取上一步结果 + 给下面的调用返回值】
        ...
        // 5.5.方法执行完成后，对返回值加工。如果出现异常也可以进行处理
