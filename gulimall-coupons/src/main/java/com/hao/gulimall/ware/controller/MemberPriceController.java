...
public class MemberPriceController {
     ...
     */
    @RequestMapping("/list")
//    @RequiresPermissions("ware:memberprice:list")
...
//   @RequiresPermissions("ware:memberprice:info")
     ...
     */
    @RequestMapping("/save")
//   @RequiresPermissions("ware:memberprice:save")
...
//    @RequiresPermissions("ware:memberprice:update")
...
//    @RequiresPermissions("ware:memberprice:delete")
